/**
 * Licences Services - Application Layer Export
 *
...
/**
 * Licences Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for licences domain.
 */
