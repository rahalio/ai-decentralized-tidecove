/**
 * Entitlements Services - Application Layer Export
 *
...
/**
 * Entitlements Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for entitlements domain.
 */
