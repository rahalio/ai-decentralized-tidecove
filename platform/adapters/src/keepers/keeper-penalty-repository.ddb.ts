/**
 * KeeperPenaltyRepository - DynamoDB Implementation
 *
...
/**
 * KeeperPenaltyRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing KeeperPenalty repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { KeeperPenaltyRepository } from "@tidecove/services/keepers";
...
/**
 * KeeperPenaltyRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: KEEPER_PENALTY
 * Entity Token: KEEPER_PENALTY
 * SK Prefix: KEEPER_PENALTY
 */
export class KeeperPenaltyRepositoryDdb implements KeeperPenaltyRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "KEEPER_PENALTY";
  private readonly ENTITY_TOKEN = "KEEPER_PENALTY";
  private readonly SK_PREFIX = "KEEPER_PENALTY";
  ...
  private readonly ENTITY_TYPE_PK = "KEEPER_PENALTIES";
