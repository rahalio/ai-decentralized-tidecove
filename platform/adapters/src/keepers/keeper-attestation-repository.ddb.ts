/**
 * KeeperAttestationRepository - DynamoDB Implementation
 *
...
/**
 * KeeperAttestationRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing KeeperAttestation repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { KeeperAttestationRepository } from "@tidecove/services/keepers";
...
/**
 * KeeperAttestationRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: KEEPER_ATTESTATION
 * Entity Token: KEEPER_ATTESTATION
 * SK Prefix: KEEPER_ATTESTATION
 */
export class KeeperAttestationRepositoryDdb implements KeeperAttestationRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "KEEPER_ATTESTATION";
  private readonly ENTITY_TOKEN = "KEEPER_ATTESTATION";
  private readonly SK_PREFIX = "KEEPER_ATTESTATION";
  ...
  private readonly DOMAIN = "KEEPERS";
  private readonly ENTITY_TYPE_PK = "KEEPER_ATTESTATIONS";
  private generateCorrelationId(): string {
    const domainPrefix = "kpr";
