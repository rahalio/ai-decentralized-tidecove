 ...
 *
 * DDD: Infrastructure adapter implementing Dispute repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { DisputeRepository } from "@tidecove/services/participants";
...
/**
 * DisputeRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: DISPUTE
 * Entity Token: DISPUTE
 * SK Prefix: DISPUTE
 */
export class DisputeRepositoryDdb implements DisputeRepository {
  ...
  private readonly ENTITY_TYPE = "DISPUTE";
  private readonly ENTITY_TOKEN = "DISPUTE";
  private readonly SK_PREFIX = "DISPUTE";
  ...
  private readonly ENTITY_TYPE_PK = "DISPUTES";
