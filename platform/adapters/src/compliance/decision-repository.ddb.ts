...
import type { DecisionRepository } from "@tidecove/services/compliance";
 ...
 *
 * Entity Type: PURPOSE_GATE_DECISION
 * Entity Token: PURPOSE_GATE_DECISION
 * SK Prefix: PURPOSE_GATE_DECISION
 */
export class DecisionRepositoryDdb implements DecisionRepository {
  ...
  private readonly ENTITY_TYPE = "PURPOSE_GATE_DECISION";
  private readonly ENTITY_TOKEN = "PURPOSE_GATE_DECISION";
  private readonly SK_PREFIX = "PURPOSE_GATE_DECISION";
  ...
  private readonly ENTITY_TYPE_PK = "PURPOSE_GATE_DECISIONS";
  ...
  async listPurposeGateDecisions(input: Parameters<DecisionRepository['listPurposeGateDecisions']>[0]): Promise<Awaited<ReturnType<DecisionRepository['listPurposeGateDecisions']>>> {
