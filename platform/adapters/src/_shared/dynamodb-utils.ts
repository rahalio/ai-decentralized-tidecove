 ...
 *
 * @returns The core table name (e.g., "tidecove-core-dev")
 ...
 *
 * @returns The base table name (e.g., "tidecove-base-dev")
 ...
 *
 * @returns The analytics table name (e.g., "tidecove-analytics-dev")
 ...
 *
 * @returns The realtime table name (e.g., "tidecove-app-realtime-dev")
